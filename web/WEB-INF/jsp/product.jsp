    ...
    <div class="span18 last">
        ...
        <div class="productImage">
            <div class="zoomPad">
                <img style="opacity: 1;" title="" class="medium"
                     src="${pageContext.request.contextPath}/${product.product_image}">
                <div
        ...
        <div class="info">
            <dl>
                <dt>优惠价:</dt>
                <dd>
                    <strong>￥： ${product.product_specialprice} 元
                    </strong> 市 场 参 考 价：
                    <del>
                        ￥
        ...
        <form id="cartForm" action="${pageContext.request.contextPath }/addCart"  method="post" >
            <input type="hidden" name="pid" value="${product.product_id}"></input>
