					...
					<form id="registerForm" method="post"
						...
						<table>
							<tbody>
								...
								<tr>
									<th><span class="requiredField"></span>电子邮箱:</th>
								...
								<tr>
									<th>姓名:</th>
									<td><input type="text" name="user_realname" class="text"
										maxlength="200"></td>
								</tr>
								<tr>
									<th>电话:</th>
									<td><input type="text" name="user_phone" class="text"></td>
								</tr>

								<tr>
									<th>地址:</th>
									<td><input type="text" name="user_address" class="text"
										maxlength="200">
								...
								<tr>
									<th>性别：</th>
									<td>
										<input type="text" name="user_gender" class="text"
											   maxlength="200">
									</td>
								</tr>
								<tr>
						...
						<div class="login">
							...
							<dl>
								<dt>已经拥有账号了？</dt>
								<dd>
									立即登录即可体验在线购物！ <a href="${pageContext.request.contextPath}/login">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
